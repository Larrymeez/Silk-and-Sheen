...
function ProductPage() {
  ...
  // Category-aware navigation (works for any category, not just clip-ins)
  const categoryPath = `/${product?.category || "clip-ins"}`;
  const categoryLabel =
    product?.category
      ?.split("-")
  ...
  const [inches, setInches] = useState(product?.startingLength || 14);
  ...
  const price =
    product.basePrice + (inches - product.startingLength) * product.pricePerExtraInch;
  ...
  return (
    <motion.main
      className="min-h-screen bg-brandbg text-white px-4 sm:px-6 md:px-10 lg:px-20 py-24 sm:py-28"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            {/* Product Name */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-wide mb-4">
              {product.name}
            </h1>
            ...
            <div className="mb-8">
              ...
              <p className="text-2xl sm:text-3xl font-semibold text-gold">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-gold font-semibold text-sm sm:text-base">{inches}"</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mb-5">
                {[14, 16, 18, 20, 22, 24].map((length) => (
                  <button
                    ...
                    className={`px-3 sm:px-4 py-2 text-sm sm:text-base rounded-md border transition ${
                      inches === length
              ...
              <div className="flex justify-between text-xs text-gray-500 mt-2">
                <span>{product.startingLength}"</span>
                <span>30"</span>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <label className="block font-semibold mb-3 text-sm sm:text-base">Quantity</label>

              <div className="flex items-center w-fit border border-gray-600 rounded-md overflow-hidden">

                <button
                  onClick={decreaseQuantity}
                  className="px-3 sm:px-4 py-2.5 sm:py-3 hover:bg-gray-800 transition"
                  aria-label="Decrease quantity"
                >
                  <FiMinus />
                </button>

                <span className="px-4 sm:px-6 py-2.5 sm:py-3 border-x border-gray-600 min-w-[50px] sm:min-w-[60px] text-center">
                  {quantity}
                </span>
            ...
            <div className="border-t border-gray-700 pt-6 mb-8">
              ...
              <div className="flex justify-between text-sm sm:text-base text-gray-400 mb-3">
                <span>{inches}" length</span>
                <span>KES {price.toLocaleString()}</span>
              </div>

              <div className="flex justify-between text-sm sm:text-base text-gray-400 mb-4">
                <span>Quantity</span>
                <span>× {quantity}</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-3 bg-gold text-black px-6 py-3.5 sm:py-4 rounded-md font-semibold hover:bg-yellow-600 transition transform hover:scale-[1.02]"
              >
                <FiShoppingBag />
                Add to Cart
              </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-gray-700 pt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-300">Premium quality hair</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-300">Easy shopping</span>
              </div>
